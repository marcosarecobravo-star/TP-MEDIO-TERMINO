export default class Game extends Phaser.Scene {
  ...
  init() {
    ...
    this.elevatorX = 780;
    this.elevatorTopY = 370;
    this.elevatorBottomY = 580;
    ...
    this.elevator2X = 30;
    this.elevator2TopY = 140;
    this.elevator2BottomY = 400;
    this.elevator2Speed = 70;
    this.elevator2Direction = 1;
    this.elevator2 = null;

    // Tercer ascensor: sube y baja en el centro superior
    this.elevator3X = 380;
    this.elevator3TopY = 360;
    this.elevator3BottomY = 430;
    this.elevator3Speed = 80;
    this.elevator3Direction = 1;
    this.elevator3 = null;

        // cuarto ascensor: sube y baja en el centro superior
    this.elevator4X = 380;
    this.elevator4TopY = 180;
    this.elevator4BottomY = 290;
    this.elevator4Speed = 80;
  ...
  createEnvironment() {
    ...
    const platformPositions = [
      { x: 400, y: 584, width: 1800 },
      { x: 170, y: 230, width: 150 },
      { x: 600, y: 390, width: 240 },
      { x: 170, y: 390, width: 150 },
      { x: 520, y: 230, width: 90 },
      { x: 660, y: 230, width: 300 },
      { x: 380, y: 90, width: 90 },
      { x: 30, y: 90, width: 190 },
    ];
    ...
    this.cementZone = this.physics.add.staticImage(360, 520, "cement");
    this.cementZone.setAlpha(0.8);

    this.oilZone = this.physics.add.staticImage(660, 340, "oil");
    this.oilZone.setAlpha(0.85);

    this.goalZone = this.add.image(740, 140, "goal");
    ...
    // Tercer ascensor en el centro superior, ayuda a alcanzar la plataforma más alta
    ...
    // cuarto ascensor en el centro superior, ayuda a alcanzar la plataforma más alta
    this.elevator4 = this.physics.add.sprite(this.elevator4X, this.elevator4BottomY, "elevator");
    this.elevator4.setImmovable(true);
    this.elevator4.body.allowGravity = false;
    this.elevator4.setDepth(1);
    this.elevator4.setSize(140, 24);
  ...
  createUI() {
    ...
    this.instructionsText = this.add.text(this.scale.width / 2, this.scale.height / 2, "MovimieA/D o ←→ para moverse, Espacio para saltar, E/Q para empujar al NPC, Súbete al ascensor para alcanzar plataformas altas.", {
      font: "24px Arial",
      fill: "#ffffff",
      align: "center",
      wordWrap: { width: 760 },
  ...
  endGame(message) {
    ...
    if (message.includes("Nivel completado")) {
      ...
      this.statusText.setText(`${message}\nPerdiste una vida. Te quedan ${livesRemaining} vidas. Presiona R para reiniciar.`);
    } else {
